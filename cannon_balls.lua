...
local speed = 100
local radius = 3
steampunk_blimp.register_shell("steampunk_blimp:shell1", "steampunk_blimp_shell_ico.png", "steampunk_blimp_ball.png", "Cannon Shell 1", direct_impact_damage, radius, speed)
