...
local function delete_hud(player, ids, player_name)
...
function steampunk_blimp.remove_hud(player)
    if player then
        ...
        if ids then
            delete_hud(player, ids, player_name)

            core.after(1.0, function(player, ids, player_name)
                delete_hud(player, ids, player_name)
            end, player, ids, player_name)
        end
    end
